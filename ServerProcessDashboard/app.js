    ...
    var RunningServerProcessService = (function () {
        function RunningServerProcessService($http, $q, $rootScope, configurationService) {
            ...
            this.getById = function (id) {
                ...
                _this.$http({ method: "GET", url: _this.getBaseUri() + "getbyid?id=" + id }).then(function (results) {
                    _this.dataStore.getByGuid = results.data;
                    deferred.resolve(results.data);
                }).catch(function (error) {
                    deferred.reject(error);
                });
            ...
            this.getByGuid = function (guid) {
                var deferred = _this.$q.defer();
                if (_this.dataStore.getByGuid && _this.dataStore.getByGuid.guid == guid) {
                    deferred.resolve(_this.dataStore.getByGuid);
                    return deferred.promise;
                }
                _this.$http({ method: "GET", url: _this.getBaseUri() + "getByGuid?guid=" + guid }).then(function (results) {
                    _this.dataStore.getByGuid = results.data;
                    deferred.resolve(results.data);
                }).catch(function (error) {
                    deferred.reject(error);
    ...
    var ServerProcessService = (function () {
        function ServerProcessService($http, $q, $rootScope, configurationService) {
            ...
            this.getById = function (id) {
                ...
                _this.$http({ method: "GET", url: _this.getBaseUri() + "getbyid?id=" + id }).then(function (results) {
                    _this.dataStore.getById = results.data;
                    deferred.resolve(results.data);
                }).catch(function (error) {
                    deferred.reject(error);
                });
            ...
            this.run = function (options) {
                var deferred = _this.$q.defer();
                _this.$http({ method: "POST", url: _this.getBaseUri() + "run", data: {
